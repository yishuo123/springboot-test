...
<head>
    ...
    <style type="text/css">
        ...
        .ui-th-ltr .ui-jqgrid-sortable{text-align: center; }
    </style>
</head>
<body class="common-body">
	...
	<style type="text/css">
		...
		#dialog-confirm .alert #export-form .confirm-text .dropdown .dropdown-menu{z-index: 99999; }
		#dialog-confirm .alert #export-form .confirm-text .dropdown .dropdown-menu li{background-color: #F1F1F1; height: 20px; padding-top: 0px;}
		#dialog-confirm .alert #export-form .confirm-text .dropdown .dropdown-menu li a{padding-top: 0px; padding-left:10px; }
		#dialog-confirm .alert #export-form .confirm-text .dropdown .dropdown-menu li img{width: 16px; height: 16px;}
	</style>
				...
				<form id="menuInfo-form" class="form-horizontal" action="${path }/admin/menuInfo/add" method="post">
					...
					<div class="form-group">
						...
						<div class="col-xs-12 col-sm-9">
							<div class="clearfix">
								<input type="text" name="menuName" id="menuName-input" class="col-xs-12 col-sm-6 info-form"/>
							</div>
						</div>
					</div>
					<div id="menuIcon-div" class="form-group">
						...
						<div class="col-xs-12 col-sm-9">
							<div class="clearfix">
								<input type="text" name="menuIcon" id="menuIcon-input" class="col-xs-12 col-sm-6 info-form"/>
							</div>
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="menuLevel-select">菜单等级:</label>
					...
					<div id="menuParent-group" class="form-group hide">
						<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="menuParent-select">父级菜单:</label>
					...
					<div class="form-group">
						<label class="control-label col-xs-12 col-sm-3 no-padding-right" for="displayOrder-input">显示顺序:</label>

						<div class="col-xs-12 col-sm-9">
							<div class="clearfix">
								<input type="text" name="displayOrder" id="displayOrder-input" class="col-xs-12 col-sm-6 info-form"/>
							</div>
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-xs-12 col-sm-9">
							<div class="clearfix">
								<textarea class="input-xlarge" cols="1.5" name="remark" id="remark-textarea" style="max-width: 180px;"></textarea>
							</div>
						</div>
					</div>
				</form>
