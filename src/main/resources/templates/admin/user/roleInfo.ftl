				...
				<div class="widget-content nopaddinfg">
					<form id="roleMenuInfo-form" action="${path }/admin" method="post">
						...
						<table id="roleMenuInfo-table" class="table table-bordered table-striped with-check table-hover">
							<thead>
								<tr>
									<th width="5%"><input type="checkbox" id="title-table-checkbox" name="title-table-checkbox" /></th>
									<th width="95%">菜单名称</th>
								</tr>
							</thead>
							<tbody></tbody>
                ...
                <form id="roleInfo-form" class="form-horizontal" action="${path }/admin/roleInfo/add" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <div class="clearfix">
                                <input type="text" name="roleName" id="roleName-input" class="col-xs-12 col-sm-6 info-form"/>
                            </div>
                        </div>
                    </div>
                    <div id="roleCode-div" class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <div class="clearfix">
                                <input type="text" name="roleCode" id="roleCode-input" class="col-xs-12 col-sm-6 info-form"/>
                            </div>
                        </div>
                    </div>
                </form>
