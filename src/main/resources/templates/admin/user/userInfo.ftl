						...
						<div class="widget-main">
							<div class="form-panl">
								<label for="search-userName">用户账户:
									<input id="search-userName" type="text" class="form-control" style="width: 150px;" placeholder="请输入用户账户"/>
								</label>
								<label fol="search-phone">手机号码:
									<input id="search-phone" type="text" class="form-control" style="width: 150px;" placeholder="请输入手机号码"/>
								</label>
			...
			<form id="userinfo-form" class="form-horizontal" action="${path }/admin/userInfo/add" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="userName" id="userName-input" class="col-xs-12 col-sm-6 info-form"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="clearfix">
                            <input type="text" name="realName" id="realName-input" class="col-xs-12 col-sm-6 info-form"/>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                        <div class="clearfix">
                            <textarea type="text" name="remark" id="remark-input" class="col-xs-12 col-sm-6 info-form"></textarea>
                        </div>
                    </div>
                </div>
			</form>
